  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">S&OP overview and key metrics</p>
      </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <button
                ...
                className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors text-left"
              >
                <div>
